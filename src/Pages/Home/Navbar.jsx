...
const Navbar = () => {
  ...
  const paths = (
    ...
    return (
      <header
        className={`flex flex-wrap md:justify-start md:flex-nowrap relative z-10 w-full text-sm`}
      >
        <nav
          className="mt-6 relative max-w-7xl w-full border border-gray-200 rounded-[36px] mx-2 py-3 px-4 md:flex md:items-center md:justify-between md:py-0 md:px-6 lg:px-8 xl:mx-auto dark:bg-gray-800 dark:border-gray-700"
          aria-label="Global"
        >
          ...
          >
            <div className="flex flex-col gap-y-4 gap-x-0 mt-5 md:flex-row md:items-center md:justify-end md:gap-y-0 md:gap-x-7 md:mt-0 md:pl-7">
              ...
              <div className="">
                <Link
                  to={"/login"}
                  className={`flex items-center gap-x-2 font-medium  md:border-l  md:my-6 md:pl-6 ${
                    dark
