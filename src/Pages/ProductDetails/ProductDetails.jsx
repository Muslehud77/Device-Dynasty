...
const handleAddToCart = () =>{
  fetch("http://localhost:5000/cart", {
    ...
    return (
      <div className="flex container mx-auto relative my-10 flex-col-reverse">
        <div
          className={`container ${
            !showFull && "h-screen"
          ...
          <div className=" gap-4 md:gap-8 xl:gap-20 xl:items-center">
            <div className={`flex justify-center`}>
              <img
                ...
                } duration-1000 w-[600px] object-contain h-96 rounded-md`}
                src={photo}
            ...
            <div className="flex justify-center items-center">
              <div className="w-full container">
                ...
                <div className="flex justify-center md:justify-end my-10">
                  <div className="overflow-hidden rounded-lg has-shadow shadow-2xl  w-96  flex flex-col gap-2">
                    <div className="p-4">
                    ...
                    <div className="flex bg-gray-700 rounded-tl-2xl">
                      ...
                      <div className="w-full">
                        <button
                          ...
                          className="btn rounded-none text-white hover:bg-cyan-600 bg-[#65C9C0] w-full btn-sm"
                        >
                          Add to Cart <BsCart />
                        </button>
                      </div>
